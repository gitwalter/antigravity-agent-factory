...
> See [Configuration Guide](../setup/configuration.md) to customize for your environment.
...
3. Execute **Post-Extension Automation** (Rule 6):
   ...
   - Update `CHANGELOG.md`
   - Run `scripts/validation/sync_manifest_versions.py --sync`
   - Run `scripts/validation/validate_readme_structure.py --update`
...
|---------------|-------------|
| Knowledge file (new) | manifest.json + knowledge-files.md + CHANGELOG.md |
