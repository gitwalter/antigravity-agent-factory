...
> 🧠 **Memory System**: The agent learns from your corrections and preferences. All memories require your approval before being stored. See [MEMORY_SYSTEM.md](MEMORY_SYSTEM.md) for chat commands.
...
See [Blueprints Reference](reference/BLUEPRINTS.md) for detailed specifications.
...
- **See [GENERATED_OUTPUT.md](reference/GENERATED_OUTPUT.md)** for complete details on all generated capabilities
...
See [Guardian Coordination](reference/GUARDIAN_COORDINATION.md) for complete documentation.
