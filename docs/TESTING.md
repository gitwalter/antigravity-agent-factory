...
The test suite consists of **1138 tests** organized into five specialized categories:

| Category | Count | Purpose |
|----------|-------|---------|
| | | Unit Tests | ~696 | | | Atomic validation of individual functions and classes. |
| | | Integration Tests | ~155 | | | Verification of component interactions and CLI flows. |
| | | Validation Tests | ~211 | | | Ensuring all JSON/Markdown patterns adhere to schemas. |
