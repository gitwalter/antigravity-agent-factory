...
class ContractRegistry:
    ...
    def create_contract(
        self, parties: List[Party], capabilities: Dict[str, List[str]], **kwargs
    ) -> AgentContract:
        """
    ...
    def sign(self, contract_id: str, agent_id: str, signature: str) -> bool:
        ...
        with self._lock:
            ...
            if not contract.get_party(agent_id):
                logger.warning(
                    f"Agent {agent_id} is not a party to contract {contract_id}"
                )
                return False
    ...
    def find_contracts(
        self, agent_a: str, agent_b: Optional[str] = None, active_only: bool = True
    ) -> List[AgentContract]:
        """
    ...
    def find_by_role(
        self, agent_id: str, role: str, active_only: bool = True
    ) -> List[AgentContract]:
        """
