...
**Note:** Directory paths (knowledge/, templates/, .cursor/skills/, etc.) are configurable via `.cursor/config/settings.json`.
...
- **Skill**: `.cursor/skills/research-first/SKILL.md`
