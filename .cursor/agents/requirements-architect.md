...
**Note:** Directory paths (knowledge/, blueprints/, workflows/, etc.) are configurable via `.cursor/config/settings.json`. Target project paths should be provided as generic paths (e.g., `path/to/project` or `{TARGET_DIR}`).
