...
- Building text-to-SQL interfaces
- Creating database query assistants
- Implementing schema-aware SQL generation
- Optimizing database queries with LLMs
- Building data analysis agents

## Prerequisites

```bash
pip install langchain langchain-core sqlalchemy
pip install langchain-google-genai  # Or other LLM provider
```
