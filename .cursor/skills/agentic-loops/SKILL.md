...
- Building agents that need to reason and act iteratively
- Implementing ReAct (Reasoning + Acting) patterns
- Creating self-correcting agents
- Building planning and task decomposition systems
...
- Knowledge: `knowledge/agentic-loop-patterns.json`
