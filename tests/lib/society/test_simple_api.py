...
class TestSimpleSociety:
    ...
    def test_create_society_with_preset(self):
        ...
        society = create_agent_society(
            "TestSociety",
            preset=SocietyPreset.PRODUCTION
        )
    ...
    def test_broadcast_message(self):
        ...
        society = create_agent_society(
            "TestSociety",
            agents=["broadcaster", "receiver1", "receiver2", "receiver3"]
        )
    ...
    def test_broadcast_with_exclude(self):
        ...
        society = create_agent_society(
            "TestSociety",
            agents=["broadcaster", "receiver1", "receiver2", "excluded"]
        )
...
class TestPresets:
    ...
    def test_pipeline_society(self):
        ...
        society = create_pipeline_society(
            "DataPipeline",
            stage_ids=["extract", "transform", "load"]
        )
...
class TestSocietyBuilder:
    ...
    def test_builder_with_preset(self):
        ...
        society = (SocietyBuilder("TestProject")
            .with_preset(SocietyPreset.PRODUCTION)
            .build())
...
class TestSendResult:
    ...
    def test_send_result_with_violations(self):
        ...
        result = SendResult(
            verified=False,
            violations=["A1 violation", "A2 violation"]
        )
...
class TestIntegration:
    ...
    def test_full_workflow(self):
        ...
        society = create_agent_society(
            "IntegrationTest",
            agents=["orchestrator", "analyzer", "reporter"]
        )
