...
class TestAgentBundle:
    ...
    def test_bundle_checksum(self):
        ...
        bundle1 = (create_bundle("agent", "Agent")
            .add_skill("skill", "content"))
        
        bundle2 = (create_bundle("agent", "Agent")
            .add_skill("skill", "content"))
    ...
    def test_to_dict_and_from_dict(self):
        ...
        original = (create_bundle("agent", "Agent", "1.0.0")
...
class TestBundleTransfer:
    ...
    def test_import_from_directory(self):
        ...
        original = (create_bundle("agent", "Agent")
            .add_skill("skill", "content"))
...
class TestBundleMerging:
    ...
    def test_merge_bundles(self):
        ...
        bundle1 = (create_bundle("agent1", "Agent 1")
            .add_skill("skill1", "content1"))
        
        bundle2 = (create_bundle("agent2", "Agent 2")
            .add_skill("skill2", "content2"))
    ...
    def test_merge_with_overlay_conflict(self):
        ...
        base = (create_bundle("agent", "Base")
            .add_skill("shared", "base content"))
        
        overlay = (create_bundle("agent", "Overlay")
            .add_skill("shared", "overlay content"))
...
class TestIncrementalBundles:
    ...
    def test_incremental_detects_new(self):
        ...
        previous = (create_bundle("agent", "Agent", "1.0.0")
            .add_skill("skill1", "content1"))
        
        current = (create_bundle("agent", "Agent", "1.1.0")
            .add_skill("skill1", "content1")
            .add_skill("skill2", "content2"))
    ...
    def test_incremental_detects_changed(self):
        ...
        previous = (create_bundle("agent", "Agent", "1.0.0")
            .add_skill("skill1", "original"))
        
        current = (create_bundle("agent", "Agent", "1.1.0")
            .add_skill("skill1", "modified"))
