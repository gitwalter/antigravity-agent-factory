...
class TestMeritocracy:
    ...
    def test_reputation_weighted_voting(self):
        ...
        assert society.get_voting_weight("high-rep") > society.get_voting_weight("low-rep")
...
class TestHierarchy:
    ...
    def test_role_voting_weight(self):
        ...
        assert society.get_voting_weight("leader") > society.get_voting_weight("manager")
        assert society.get_voting_weight("manager") > society.get_voting_weight("member")
