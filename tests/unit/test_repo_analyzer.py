...
class TestRepoInventory:
    ...
    def test_get_summary_with_artifacts(self):
        ...
        inventory.agentrules = AntigravityruleAnalysis(
            exists=True, line_count=100, layers_present=[0, 1, 2], version="2.0.0"
        )
...
class TestRepoAnalyzer:
    ...
    def test_detect_tech_stack_java_spring(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            (repo_path / "pom.xml").write_text(
                "<project><spring-boot></spring-boot></project>"
            )
    ...
    def test_determine_scenario_upgrade(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            assert inventory.scenario in [
                OnboardingScenario.UPGRADE,
