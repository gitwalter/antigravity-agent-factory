...
def sample_knowledge_file(tmp_knowledge_dir):
    ...
    content = {
        "version": "1.0.0",
        "metadata": {"name": "test-patterns", "description": "Test patterns"},
        "patterns": [{"id": "pattern1", "name": "Pattern 1"}],
    }
...
class TestNotificationSystemInit:
    ...
    def test_init_custom_config(self):
        ...
        config = NotificationConfig(
            quiet_mode=True, min_level=NotificationLevel.WARNING
        )
...
class TestSourceAggregatorInit:
    ...
    def test_init_initializes_adapters(
        self, mock_create, mock_get_adapters, mock_config_manager
    ):
    ...
    def test_get_enabled_adapters(self, mock_config_manager):
        ...
        with patch(
            "scripts.updates.source_aggregator.get_available_adapters", return_value=[]
        ):
            aggregator = SourceAggregator(config_manager=mock_config_manager)
...
class TestSourceAggregatorFetch:
    ...
    @pytest.mark.asyncio
    async def test_fetch_all_updates_success(
        self, mock_config_manager, mock_adapter, sample_knowledge_update
    ):
        ...
        with patch(
            "scripts.updates.source_aggregator.get_available_adapters",
            return_value=["github"],
        ):
            with patch(
                "scripts.updates.source_aggregator.create_adapter",
    ...
    @pytest.mark.asyncio
    async def test_fetch_all_updates_with_errors(
        self, mock_config_manager, mock_adapter
    ):
    ...
    @pytest.mark.asyncio
    async def test_fetch_all_updates_deduplication(
        self, mock_config_manager, mock_adapter, sample_knowledge_update
    ):
    ...
    @pytest.mark.asyncio
    async def test_fetch_all_updates_priority_sorting(
        self, mock_config_manager, mock_adapter
    ):
...
class TestUpdateEngineApplyUpdate:
    ...
    def test_apply_update_existing_file(
        self, tmp_knowledge_dir, sample_knowledge_file, sample_knowledge_update
    ):
    ...
    def test_apply_update_with_backup(
        self, tmp_knowledge_dir, sample_knowledge_file, sample_knowledge_update
    ):
    ...
    def test_apply_update_without_backup(
        self, tmp_knowledge_dir, sample_knowledge_file, sample_knowledge_update
    ):
    ...
    def test_apply_update_validation_error(
        self, tmp_knowledge_dir, sample_knowledge_update
    ):
    ...
    def test_apply_update_exception_handling(
        self, tmp_knowledge_dir, sample_knowledge_update
    ):
...
class TestUpdateEngineMergeStrategies:
    ...
    def test_merge_conservative(
        self,
        tmp_knowledge_dir,
        sample_knowledge_file,
        sample_knowledge_update,
        sample_update_source,
    ):
        ...
        result = engine.apply_update(
            conservative_update, strategy=MergeStrategy.CONSERVATIVE
        )
    ...
    def test_merge_balanced(
        ...
        result = engine.apply_update(
            sample_knowledge_update, strategy=MergeStrategy.BALANCED
        )
    ...
    def test_merge_aggressive(
        ...
        result = engine.apply_update(
            sample_knowledge_update, strategy=MergeStrategy.AGGRESSIVE
        )
...
class TestUpdateEngineBatch:
    ...
    def test_apply_batch_partial_failure(
        self, tmp_knowledge_dir, sample_knowledge_update
    ):
...
class TestUpdateEngineValidation:
    ...
    def test_validate_content_valid(self, tmp_knowledge_dir):
        ...
        content = {"version": "1.0.0", "metadata": {}}
    ...
    def test_validate_content_invalid_version(self, tmp_knowledge_dir):
        ...
        content = {"version": "invalid", "metadata": {}}
...
class TestSourceAggregatorEdgeCases:
    ...
    @pytest.mark.asyncio
    async def test_fetch_all_updates_with_target_files_filter(
        self, mock_config_manager, mock_adapter, sample_knowledge_update
    ):
        ...
        with patch(
            ...
            with patch(
                ...
                result = await aggregator.fetch_all_updates(
                    target_files=["test-patterns.json"]
                )
    ...
    @pytest.mark.asyncio
    async def test_fetch_all_updates_with_since_filter(
        self, mock_config_manager, mock_adapter, sample_knowledge_update
    ):
    ...
    @pytest.mark.asyncio
    async def test_fetch_from_adapter_connection_failure(
        self, mock_config_manager, mock_adapter
    ):
        ...
        with patch(
            ...
            with patch(
                ...
                updates, errors = await aggregator._fetch_from_adapter(
...
class TestUpdateEngineEdgeCases:
    ...
    def test_apply_update_with_checksum(
        self, tmp_knowledge_dir, sample_knowledge_update
    ):
    ...
    def test_apply_update_without_proposed_content(
        self, tmp_knowledge_dir, sample_update_source
    ):
    ...
    def test_deep_merge_nested_structures(
        self, tmp_knowledge_dir, sample_knowledge_file, sample_update_source
    ):
        ...
        update = KnowledgeUpdate(
            ...
            proposed_content={
                "version": "1.1.0",
                "metadata": {"nested": {"deep": {"value": "updated"}}},
            },
        )
    ...
    def test_merge_conservative_preserves_existing(
        self, tmp_knowledge_dir, sample_knowledge_file, sample_update_source
    ):
