...
from scripts.core.generate_project import ProjectGenerator  # noqa: E402
...
class TestBlueprintLoading:
    ...
    def test_load_blueprint_none_when_not_specified(
...
class TestAntigravityrulesGeneration:
    ...
    def test_cursorrules_no_placeholder_remnants(
        self, sample_generator, temp_output_dir
    ):
