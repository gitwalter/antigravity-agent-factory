...
from scripts.validation.validate_readme_structure import StructureValidator, main
...
class TestUpdateReadme:
    ...
    def test_update_with_structure_section(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            validator = StructureValidator(root)
            with patch.object(
                StructureValidator, "scan_all", return_value={"agents": 8}
            ):
                result = validator.update_readme()
...
class TestMain:
    ...
    def test_main_check_mode(self, capsys):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            with patch(
                "sys.argv",
                ["validate_readme_structure.py", "--check", "--root", str(root)],
            ):
                result = main()
    ...
    def test_main_generate_mode(self, capsys):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            with patch(
                "sys.argv",
                ["validate_readme_structure.py", "--generate", "--root", str(root)],
            ):
                result = main()
    ...
    def test_main_json_mode(self, capsys):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            with patch(
                "sys.argv",
                ["validate_readme_structure.py", "--json", "--root", str(root)],
            ):
                result = main()
    ...
    def test_main_default_is_check(self, capsys):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            with patch(
                "sys.argv", ["validate_readme_structure.py", "--root", str(root)]
            ):
                result = main()
