...
class TestCoverageScore:
    ...
    def test_coverage_ratio_calculation(self):
        ...
        score = CoverageScore(
            topic_name="test", topic_path="test", current_depth=1, required_depth=2
        )
    ...
    def test_coverage_ratio_capped_at_one(self):
        ...
        score = CoverageScore(
            topic_name="test", topic_path="test", current_depth=5, required_depth=2
        )
    ...
    def test_is_adequate_true(self):
        ...
        score = CoverageScore(
            topic_name="test", topic_path="test", current_depth=3, required_depth=2
        )
    ...
    def test_is_adequate_false(self):
        ...
        score = CoverageScore(
            topic_name="test", topic_path="test", current_depth=1, required_depth=3
        )
    ...
    def test_is_adequate_exact_match(self):
        ...
        score = CoverageScore(
            topic_name="test", topic_path="test", current_depth=2, required_depth=2
        )
    ...
    def test_zero_required_depth(self):
        ...
        score = CoverageScore(
            topic_name="test", topic_path="test", current_depth=0, required_depth=0
        )
...
class TestAnalysisResult:
    ...
    def test_coverage_percentage_zero_topics(self):
        ...
        result = AnalysisResult(
            gaps=[], coverage_scores=[], total_topics=0, covered_topics=0
        )
...
class TestKnowledgeGapAnalyzer:
    ...
    def test_flatten_content_dict(self, mock_knowledge_dir):
        ...
        result = analyzer._flatten_content(
    ...
    def test_save_report(self, mock_knowledge_dir, taxonomy_dir, tmp_path):
        ...
        analyzer = KnowledgeGapAnalyzer(mock_knowledge_dir, taxonomy_dir)
        result = AnalysisResult(
            gaps=[], coverage_scores=[], total_topics=5, covered_topics=3
        )
...
class TestRunGapAnalysis:
    ...
    def test_run_with_custom_taxonomy(self, knowledge_dir, taxonomy_dir):
        ...
        result = run_gap_analysis(knowledge_dir, taxonomy_name="agent_taxonomy.json")
