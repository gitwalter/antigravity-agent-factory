...
from scripts.core.generate_project import ProjectConfig
...
class TestPMConfigFields:
    ...
    def test_pm_enabled_default_false(self):
        ...
        if hasattr(config, "pm_enabled"):
            ...
            pytest.fail(
                "pm_enabled field not found in ProjectConfig. "
    ...
    def test_pm_backend_accepts_valid_values(self):
        ...
        for backend in valid_backends:
            if (
                hasattr(ProjectConfig, "__annotations__")
                and "pm_backend" in ProjectConfig.__annotations__
            ):
                config = ProjectConfig(
                    project_name="test-project", pm_enabled=True, pm_backend=backend
                )
    ...
    def test_pm_doc_backend_accepts_valid_values(self):
        ...
        for backend in valid_backends:
            if (
                hasattr(ProjectConfig, "__annotations__")
                and "pm_doc_backend" in ProjectConfig.__annotations__
            ):
                config = ProjectConfig(
                    project_name="test-project", pm_enabled=True, pm_doc_backend=backend
                )
    ...
    def test_pm_methodology_accepts_valid_values(self):
        ...
        for methodology in valid_methodologies:
            if (
                hasattr(ProjectConfig, "__annotations__")
                and "pm_methodology" in ProjectConfig.__annotations__
            ):
                config = ProjectConfig(
...
class TestPMConfigFromDict:
    ...
    def test_from_dict_with_pm_enabled(self):
        ...
        data = {"project_name": "pm-project", "pm_enabled": True}
    ...
    def test_from_dict_with_full_pm_config(self):
        ...
        if hasattr(config, "pm_enabled"):
            ...
            pytest.fail(
                "PM fields not found in ProjectConfig. "
    ...
    def test_from_dict_pm_disabled_by_default(self):
        ...
        data = {"project_name": "no-pm-project"}
...
class TestPMAgentSkillExtension:
    ...
    def test_pm_agents_added_when_enabled(self):
        ...
        if (
            hasattr(ProjectConfig, "__annotations__")
            and "pm_enabled" in ProjectConfig.__annotations__
        ):
            config = ProjectConfig(
                project_name="pm-project", pm_enabled=True, agents=["code-reviewer"]
            )
    ...
    def test_pm_skills_added_when_enabled(self):
        ...
        if (
            ...
            config = ProjectConfig(
                project_name="pm-project", pm_enabled=True, skills=["tdd"]
            )
            ...
            if hasattr(config, "get_all_skills"):
                ...
                for pm_skill in expected_pm_skills:
                    assert (
                        pm_skill in all_skills
                    ), f"PM skill {pm_skill} not found in skills list"
            else:
                # If skills are automatically extended, they should be in config.skills
                for pm_skill in expected_pm_skills:
                    assert pm_skill in config.skills or hasattr(
                        config, "_pm_skills"
    ...
    def test_agents_unchanged_when_pm_disabled(self):
        ...
        config = ProjectConfig(project_name="no-pm-project", agents=initial_agents)
