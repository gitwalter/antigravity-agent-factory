...
class TestDependencyNode:
    ...
    def test_minimal_node(self):
        ...
        node = DependencyNode(id="test:node", node_type=NodeType.KNOWLEDGE)
...
class TestDependencyEdge:
    ...
    def test_minimal_edge(self):
        ...
        edge = DependencyEdge(
            from_node="node:1", to_node="node:2", edge_type=EdgeType.REQUIRES
        )
    ...
    def test_edge_hash(self):
        ...
        edge3 = DependencyEdge(
            from_node="node:1", to_node="node:3", edge_type=EdgeType.REQUIRES
        )
    ...
    def test_edge_equality(self):
        ...
        edge5 = DependencyEdge(
            from_node="node:1", to_node="node:1", edge_type=EdgeType.REFERENCES
        )
...
class TestValidationResult:
    ...
    def test_result_with_cycles(self):
        ...
        result = ValidationResult(cycles=[["node:1", "node:2", "node:1"]])
    ...
    def test_result_with_version_errors(self):
        ...
        result = ValidationResult(version_errors=["Invalid version constraint"])
    ...
    def test_result_is_valid_property(self):
        ...
        result4 = ValidationResult(cycles=[["cycle"]], broken_refs=["broken"])
    ...
    def test_result_has_warnings_property(self):
        ...
        # Has both
        result4 = ValidationResult(warnings=["warning"], version_errors=["error"])
    ...
    def test_scan_knowledge_complex_dependencies(self, tmp_path):
        ...
        manifest = {
            "files": {
                "file1.json": {
                    "version": "1.0.0",
                    "dependencies": [{"file": "file2.json", "minVersion": "1.0.0"}],
                },
                "file2.json": {"version": "1.0.0"},
            }
        }
        manifest_path.write_text(json.dumps(manifest))
    ...
    def test_scan_knowledge_dependencies_with_filename_key(self, tmp_path):
        ...
        manifest = {
            "files": {
                "file1.json": {
                    "version": "1.0.0",
                    "dependencies": [{"filename": "file2.json", "minVersion": "1.0.0"}],
                },
                "file2.json": {"version": "1.0.0"},
            }
        }
...
"""
        ...
        knowledge_edges = [
            e for e in validator.edges if e.to_node.startswith("knowledge:")
        ]
        assert len(knowledge_edges) == 2
        assert "knowledge:file.json" in [e.to_node for e in knowledge_edges]
        assert "knowledge:file-without-json.json" in [
            e.to_node for e in knowledge_edges
        ]
...
class TestDependencyValidatorScanBlueprints:
    ...
    def test_scan_blueprints_valid(self, tmp_path):
        ...
        blueprint = {
            ...
            "agents": [{"patternId": "agent-pattern"}],
            "skills": [{"patternId": "skill-pattern"}],
            "knowledge": [{"filename": "knowledge-file.json"}],
        }
    ...
    def test_scan_blueprints_no_pattern_id(self, tmp_path):
        ...
        blueprint = {
            "metadata": {"blueprintId": "test-blueprint", "version": "1.0.0"},
            "agents": [
                {}  # No patternId
            ],
            "skills": [{"patternId": "skill-pattern"}],
...
class TestDependencyValidatorFindBrokenRefs:
    ...
    def test_find_broken_refs_exists(self, tmp_path):
        ...
        validator.nodes["node:1"] = DependencyNode("node:1", NodeType.KNOWLEDGE)
        validator.edges.append(
            DependencyEdge("node:1", "node:missing", EdgeType.REQUIRES)
        )
    ...
    def test_find_broken_refs_ignores_references(self, tmp_path):
        ...
        validator.nodes["node:1"] = DependencyNode("node:1", NodeType.KNOWLEDGE)
        validator.edges.append(
            DependencyEdge("node:1", "node:missing", EdgeType.REFERENCES)
        )
...
class TestDependencyValidatorValidateVersions:
    ...
    def test_validate_versions_no_packaging(self, tmp_path, monkeypatch):
        ...
        monkeypatch.setattr(
            "scripts.validation.dependency_validator.HAS_PACKAGING", False
        )
    ...
    def test_validate_versions_valid(self, tmp_path):
        ...
        validator.nodes["node:1"] = DependencyNode(
            "node:1", NodeType.KNOWLEDGE, version="1.0.0"
        )
        validator.nodes["node:2"] = DependencyNode(
            "node:2", NodeType.KNOWLEDGE, version="1.5.0"
        )
        validator.edges.append(
            DependencyEdge(
                "node:1", "node:2", EdgeType.REQUIRES, version_constraint="1.0.0"
            )
        )
    ...
    def test_validate_versions_invalid(self, tmp_path):
        ...
        validator.nodes["node:2"] = DependencyNode(
            "node:2", NodeType.KNOWLEDGE, version="0.5.0"
        )
        validator.edges.append(
            DependencyEdge(
                "node:1", "node:2", EdgeType.REQUIRES, version_constraint="1.0.0"
    ...
    def test_validate_versions_no_constraint(self, tmp_path):
        ...
        validator.nodes["node:1"] = DependencyNode("node:1", NodeType.KNOWLEDGE)
        validator.nodes["node:2"] = DependencyNode(
            "node:2", NodeType.KNOWLEDGE, version="1.0.0"
        )
        validator.edges.append(DependencyEdge("node:1", "node:2", EdgeType.REQUIRES))
...
class TestDependencyValidatorValidate:
    ...
    def test_validate_with_all_issues(self, tmp_path):
        ...
        validator.edges.append(
            DependencyEdge("node:1", "node:missing-ref", EdgeType.REFERENCES)
        )
...
class TestDependencyValidatorGetStatistics:
    ...
    def test_get_statistics(self, tmp_path):
        ...
        validator.nodes["knowledge:file1"] = DependencyNode(
            "knowledge:file1", NodeType.KNOWLEDGE
        )
        validator.nodes["skill:skill1"] = DependencyNode("skill:skill1", NodeType.SKILL)
        validator.edges.append(
            DependencyEdge("knowledge:file1", "skill:skill1", EdgeType.REQUIRES)
        )
        validator.edges.append(
            DependencyEdge("knowledge:file1", "skill:skill1", EdgeType.REFERENCES)
        )
    ...
    def test_get_statistics_all_node_types(self, tmp_path):
        ...
        validator.nodes["blueprint:bp1"] = DependencyNode(
            "blueprint:bp1", NodeType.BLUEPRINT
        )
        validator.nodes["template:tmpl1"] = DependencyNode(
            "template:tmpl1", NodeType.TEMPLATE
        )
        validator.nodes["pattern:pat1"] = DependencyNode(
            "pattern:pat1", NodeType.PATTERN
        )
...
class TestDependencyValidatorExportGraph:
    ...
    def test_export_graph_with_none_values(self, tmp_path):
        ...
        validator.nodes["knowledge:file1"] = DependencyNode(
            "knowledge:file1", NodeType.KNOWLEDGE, version=None, path=None, metadata={}
        )
    ...
    def test_export_graph_path_conversion(self, tmp_path):
        ...
        validator.nodes["knowledge:file1"] = DependencyNode(
            "knowledge:file1", NodeType.KNOWLEDGE, path=test_path
        )
...
class TestDependencyValidatorScanArtifacts:
    ...
    def test_scan_artifacts_full(self, tmp_path):
        ...
        manifest = {"files": {"file1.json": {"version": "1.0.0", "title": "File 1"}}}
        ...
        bp_dir = tmp_path / ".agent" / "blueprints" / "test-blueprint"
        bp_dir.mkdir(parents=True)
        blueprint = {"metadata": {"blueprintId": "test-blueprint", "version": "1.0.0"}}
    ...
    def test_scan_artifacts_builds_adjacency(self, tmp_path):
        ...
        manifest = {
            "files": {
                "file1.json": {"version": "1.0.0", "dependencies": ["file2.json"]},
                "file2.json": {"version": "1.0.0"},
            }
        }
        (knowledge_dir / "manifest.json").write_text(json.dumps(manifest))
