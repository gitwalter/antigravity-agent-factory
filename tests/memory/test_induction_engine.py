...
class TestInductionEngine:
    ...
    def test_rejected_proposal_not_re_proposed(self, engine):
        ...
        proposal = engine.observe({
            "type": "user_correction",
            "content": "Use unittest for Python testing"
        })
    ...
    def test_edit_and_accept_proposal(self, engine):
        ...
        memory = engine.edit_and_accept_proposal(
            proposal.id,
            "Always use pytest with fixtures for Python testing"
        )
    ...
    def test_get_status(self, engine):
        ...
        engine.observe({
            "type": "user_correction",
            "content": "Test observation for status check"
        })
    ...
    def test_get_status_message(self, engine):
        ...
        engine.observe({
            "type": "user_correction",
            "content": "Test for status message"
        })
...
class TestInductionEngineSession:
    ...
    def test_session_tracks_observations(self, engine):
        ...
        engine.observe({
            "type": "user_correction",
            "content": "First observation in session"
        })
        engine.observe({
            "type": "preference",
            "content": "Second observation in session"
        })
    ...
    def test_end_session_stores_episodic(self, engine):
        ...
        engine.observe({
            "type": "user_correction",
            "content": "Session observation to store"
        })
