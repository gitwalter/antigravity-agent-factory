...
def create_engine(
    factory_root: Optional[Path] = None, additional_dirs: Optional[List[Path]] = None
) -> TemplateEngine:
    """
...
def render_template(
    template_path: str, context: Dict[str, Any], factory_root: Optional[Path] = None
) -> str:
    """
...
if __name__ == "__main__":
    ...
    result = engine.render_string("{{ name | snake_case }}", {"name": "MyClassName"})
