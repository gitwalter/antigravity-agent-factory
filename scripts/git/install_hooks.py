...
# Pre-commit hook generated by Antigravity Agent Factory
...
REM Pre-commit hook generated by Antigravity Agent Factory
...
def uninstall_hook(git_dir: Path) -> bool:
    ...
    if "Antigravity Agent Factory" not in content:
        print(
            "⚠️  Pre-commit hook exists but doesn't appear to be from Antigravity Agent Factory"
        )
