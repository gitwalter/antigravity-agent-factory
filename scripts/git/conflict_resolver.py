...
class ConflictResolver:
    ...
    def detect_conflicts(
        self, existing: Dict[str, Any], incoming: Dict[str, Any], source: str = ""
    ) -> ConflictReport:
    ...
    def _can_auto_resolve(self, conflict: Conflict) -> bool:
        ...
        if (
            self.preserve_user_changes
            and self._is_user_customization_path(conflict.path)
            and conflict.suggested_resolution == ResolutionStrategy.KEEP_EXISTING
        ):
            return True
    ...
    def _apply_recursive(
        ...
        for key, value in source.items():
            ...
            if conflict:
                ...
                strategy = user_decisions.get(child_path, conflict.suggested_resolution)
    ...
    def _merge_values(
        self, existing: Any, incoming: Any, conflict_type: ConflictType
    ) -> Any:
        """Merge two values."""
