...
class EmbeddingService:
    ...
    def similarity(
        self, query: str, candidates: List[str], return_sorted: bool = False
    ...
    def most_similar(
        self, query: str, candidates: List[str], k: int = 5, threshold: float = 0.0
    ) -> List[tuple]:
        """
...
def get_embedding_service(
    model_name: str = EmbeddingService.DEFAULT_MODEL, cache_dir: str = "data/models"
) -> EmbeddingService:
    """
