...
from scripts.memory.memory_store import MemoryStore, Memory, MemoryProposal, get_memory_store
...
class MemoryIntegration:
    ...
    def get_context_for_knowledge_creation(self, topic: str) -> str:
        ...
        for memory in memories:
            ...
            lines.append(f"- {memory.content} [Source: {source}, Relevance: {similarity*100:.0f}%]")
    ...
    def record_user_correction(self, original: str, correction: str) -> Optional[MemoryProposal]:
        """
        ...
        return self.record_observation("user_correction", content, context=f"Original: {original}")
