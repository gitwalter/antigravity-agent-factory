...
"""
        (source_dir / ".cursor" / "skills" / "mock-skill" / "SKILL.md").write_text(
...
Uses: mock-skill
"""
        (source_dir / ".cursor" / "agents" / "mock-agent.md").write_text(
            agent_content, encoding="utf-8"
        )

        # Mock Rules
        (source_dir / ".cursorrules").write_text(
            "Always use defined patterns.", encoding="utf-8"
        )
