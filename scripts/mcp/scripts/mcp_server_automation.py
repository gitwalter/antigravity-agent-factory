...
def run_script(script_path, args=None):
    ...
    try:
        ...
        return {
            "content": [{"type": "text", "text": f"Error executing script: {e}"}],
            "isError": True,
        }
...
def handle_initialize(request):
    return {
        ...
        "capabilities": {"tools": {}},
        "serverInfo": {"name": "antigravity-automation", "version": "1.0.0"},
    }
            ...
            },
            {
                ...
                "inputSchema": {
                    ...
                    "properties": {
                        "source": {
                            "type": "string",
                            "description": "URL or path to source",
                        }
                    },
                    "required": ["source"],
                },
...
def handle_call_tool(request):
    ...
    if name == "run_pre_commit_check":
        ...
        if not source:
            return {
                "content": [{"type": "text", "text": "Missing source argument"}],
                "isError": True,
            }
