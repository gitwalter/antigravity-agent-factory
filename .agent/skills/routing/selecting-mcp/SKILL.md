...
- `{directories.knowledge}/mcp-servers-catalog.json` - Full server catalog
- `{directories.knowledge}/mcp-selection-guide.json` - Role/stack recommendations
...
- `{directories.knowledge}/mcp-servers-catalog.json` - Full catalog
- `{directories.knowledge}/mcp-selection-guide.json` - Recommendations
- `{directories.templates}/mcp/*/setup-guide.md` - Per-server setup guides
- `{directories.docs}/MCP-SERVERS.md` - Comprehensive documentation
