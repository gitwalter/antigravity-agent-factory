...
## Related
- Knowledge: `knowledge/pytorch-patterns.json`, `knowledge/model-training-patterns.json`
...
> [!IMPORTANT]
> Requirements:
> - Packages: torch, torchvision, torchaudio, accelerate, transformers, deepspeed, optuna, mlflow, wandb, tensorboard
> - Knowledge: pytorch-patterns.json, model-training-patterns.json, deep-learning-patterns.json
