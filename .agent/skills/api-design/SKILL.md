...
## Related
- Knowledge: `knowledge/api-design-patterns.json`
- Skill: `fastapi-development` for FastAPI implementation
- Skill: `dotnet-backend` for .NET implementation

## Prerequisites
> [!IMPORTANT]
> Requirements:
> - Knowledge: api-design-patterns.json
