...
- [Bundle Catalog](../../../docs/bundle-catalog.md) -- lists all available bundles
- [export-agent-bundle](../export-agent-bundle/SKILL.md) -- PABP export for cross-platform
- [Component Registry](../../../lib/society/pabp/component_registry.json) -- domain mappings
- [Scope Agreement](../../../lib/society/pabp/scope_agreement.py) -- profile definitions
