...
## Related
- Knowledge: `knowledge/llm-fine-tuning-patterns.json`
...
> [!IMPORTANT]
> Requirements:
> - Packages: transformers, peft, accelerate, bitsandbytes, trl, datasets, torch, torchvision, torchaudio, https://download.pytorch.org/whl/cu118
> - Knowledge: llm-fine-tuning-patterns.json
