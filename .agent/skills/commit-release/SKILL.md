...
3. **Run version sync** - `{PYTHON_PATH} scripts/validation/sync_manifest_versions.py --sync`
...
4. **Run artifact sync** - `{PYTHON_PATH} scripts/validation/sync_artifacts.py --sync --fast`
5. **Regenerate test catalog** - `{PYTHON_PATH} scripts/docs/generate_test_catalog.py`
