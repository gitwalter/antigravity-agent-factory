...
## Related
- Knowledge: `knowledge/java-containerization-patterns.json`
- Skill: `spring-microservices` for service architecture
- Skill: `spring-observability` for health checks

## Prerequisites
> [!IMPORTANT]
> Requirements:
> - Knowledge: java-containerization-patterns.json
