...
## Related
- Knowledge: `knowledge/guardrails-patterns.json`
...
> [!IMPORTANT]
> Requirements:
> - Packages: nemoguardrails, langchain-nemoguardrails, guardrails-ai, presidio-analyzer, presidio-anonymizer, transformers, torch
> - Knowledge: guardrails-patterns.json
