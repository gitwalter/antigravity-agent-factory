...
description: Interactive configuration and onboarding skill for Antigravity Agent Factory settings
type: skill
...
save_actions:
  ...
  save:
    ...
    path: .agent/config/settings.json
...
The skill creates/updates `.agent/config/settings.json`:
