...
**Process:**
- Each team member votes (show of hands or reactions)
- Majority wins
- Default if tied: Standard
- Record result as `{TOOLING_TIER}` for generation
...
- **Create psychological safety first**: Set the tone that all contributions are valued and there are no wrong answers before starting activities
- **Keep activities time-boxed and moving**: Respect the schedule; if discussions run long, capture the topic for later and move forward to maintain momentum
- **Balance participation**: Actively invite quieter team members to share while gently managing dominant voices to ensure everyone contributes
- **Capture verbatim when possible**: Record team members' exact words for hopes, headlines, and wisdom rather than paraphrasing to preserve authenticity
- **Celebrate small wins**: Acknowledge completion of each activity before moving to the next to maintain energy and engagement throughout the session
- **Confirm understanding before generation**: Review all captured information with the team before generating artifacts to ensure accuracy and alignment
...
By completing this huddle, your team has become carriers of the Factory's values:

- **Axiom Zero** is embedded in your `.cursorrules`
- **Guardian Protocol** protects your work with love and wisdom
- **Every project** you create from now on will carry these seeds forward
