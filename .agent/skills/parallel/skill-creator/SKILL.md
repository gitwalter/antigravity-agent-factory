...
- When improving or refactoring an existing skill
- When standardizing an skill to adhere to Factory schemas
- When another skill or agent requests a compliant skill
