...
description: Orchestrate the onboarding of existing repositories into the Antigravity Agent Factory ecosystem
type: agent
...
Orchestrate the seamless integration of Antigravity Agent Factory into existing repositories. This agent guides users through the onboarding process, ensuring non-destructive integration while adding factory capabilities.
...
| MINIMAL | "Found .agentrules - I'll add agents, skills, and knowledge" |
...
- .agent/skills/bugfix-workflow/SKILL.md
- knowledge/design-patterns.json

**Files to merge:**
- .agentrules (adding agent/skill references)

**Files to preserve (not touched):**
- .agent/agents/code-reviewer.md (already exists)
...
I've successfully integrated Antigravity Agent Factory into your repository.

**What was added:**
- 3 new skills (bugfix-workflow, feature-workflow, tdd)
- 2 knowledge files (design-patterns.json, security-checklist.json)
- Updated .agentrules with agent/skill references

**Preserved (not modified):**
- Your existing code-reviewer agent
- Your custom .agent/rules/ files

**Backup created:**
.agent-factory-backup/20260129_143022/
